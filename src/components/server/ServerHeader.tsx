  ...
  return (
    <DropdownMenu>
      ...
      <DropdownMenuContent className="w-56 text-xs font-medium text-black dark:text-neutral-400 space-y-[2px] dark:bg-black/30">
        ...
        {isAdmin && (
          <DropdownMenuItem className="px-3 py-2 text-sm cursor-pointer dark:hover:bg-black/20" onClick={() => {
            onOpen("editServer", {
              server
            })
          }}>
        ...
        {!isAdmin && (
          <DropdownMenuItem className="text-rose-500 dark:text-rose-500 px-3 py-2 text-sm cursor-pointer dark:hover:bg-black/20" onClick={() => {
            onOpen("leaveServer", {
              server
            });
          }}>
